    ...
    public static class SecretKeyOperation
    {
        ...
        public static void LoadSecretKey(Byte[] Key) 
        {
            ...
            else 
            {
                ...
                if (IsAuthorized == true)
                {
                    ...
                    if (IsEncryptionKeyInitialized == true && HasKeyCleared==false)
                    {
        ...
        public static void LoadMACKey(Byte[] MACKey)
        {
            ...
            else
            {
                ...
                if (IsAuthorized == true)
                {
                    ...
                    if (IsMACKeyInitialized == true && HasKeyCleared == false)
                    {
        ...
        public static Byte[] EDSBKMXChaCha20Poly1305Encrypt(Byte[] Message) 
        {
            ...
            else 
            {
                ...
                if (IsAuthorized == true && PrivateKeySigningOperation.GetIsInitialized()==true && IsEncryptionKeyInitialized==true && IsMACKeyInitialized==true)
                {
                    ...
                    SignedHashedCD = PrivateKeySigningOperation.Sign(HashedCD);
        ...
        public static Byte[] EDSBKMXChaCha20Poly1305Decrypt(Byte[] MergedCipherText) 
        {
            ...
            else
            {
                ...
                if (IsAuthorized == true && PrivateKeySigningOperation.GetIsInitialized() == true && IsEncryptionKeyInitialized == true && IsMACKeyInitialized == true)
                {
                    ...
                    HashedCD = SodiumGenericHash.ComputeHash(64,ConcatedData);
                    SodiumSecureMemory.SecureClearBytes(ConcatedData);
                    if (PrivateKeySigningOperation.GetPrivateKeyLength() == 57)
                    {
                    ...
                    DHashedCD = PrivateKeySigningOperation.Verify(SignedHashedCD);
